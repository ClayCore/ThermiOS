...
.set MULTIBOOT_FLAGS,     MULTIBOOT_ALIGN  | MULTIBOOT_MEMINFO  /* multiboot `flag` field */
.set MULTIBOOT_MAGIC,     0x1BADB002                            /* magic number lets bootloader find the header */
.set MULTIBOOT_CHECKSUM,  -(MULTIBOOT_FLAGS + MULTIBOOT_MAGIC)  /* checksum of above to prove we're multibooting */
